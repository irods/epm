...
ARFLAGS		=	crs
ARCHFLAGS	=	
CFLAGS		=	$(ARCHFLAGS) -Wall -Wformat -Wno-format-y2k -Wunused  $(OPTIM)
CXXFLAGS	=	$(ARCHFLAGS) -Wall -Wformat -Wno-format-y2k -Wunused  -fno-rtti -fno-exceptions $(OPTIM)
GUILIBS		=	
...
epm:	epm.o $(EPM_OBJS) libepm.a libepm.a libepm.a libepm.a
	echo Linking epm...
