           ...
           const char *subpackage)	/* I - Subpackage name */
{
  ...
  */
  ...
  fprintf(fp, "%%posttrans\n");

  fprintf(fp, "if [ -d /etc/irods/ ]\n");
  fprintf(fp, "then\n");
  fprintf(fp, "  MYACCTNAME=`ls -l /etc/irods/ | tail -1 | awk '{print $3}'`\n");
  fprintf(fp, "  MYGROUPNAME=`ls -l /etc/irods/ | tail -1 | awk '{print $4}'`\n");
  
  fprintf(fp, "  if [ ! -f /etc/irods/core.re ]\n");
  fprintf(fp, "  then\n");
  fprintf(fp, "    cp /var/lib/irods/packaging/core.re.template /etc/irods/core.re\n");
  fprintf(fp, "    chown $MYACCTNAME:$MYGROUPNAME /etc/irods/core.re\n");
  fprintf(fp, "  fi\n");

  fprintf(fp, "  if [ ! -f /etc/irods/core.fnm ]\n");
  fprintf(fp, "  then\n");
  fprintf(fp, "    cp /var/lib/irods/packaging/core.fnm.template /etc/irods/core.fnm\n");
  fprintf(fp, "    chown $MYACCTNAME:$MYGROUPNAME /etc/irods/core.fnm\n");
  fprintf(fp, "  fi\n");

  fprintf(fp, "  if [ ! -f /etc/irods/core.dvm ]\n");
  fprintf(fp, "  then\n");
  fprintf(fp, "    cp /var/lib/irods/packaging/core.dvm.template /etc/irods/core.dvm\n");
  fprintf(fp, "    chown $MYACCTNAME:$MYGROUPNAME /etc/irods/core.dvm\n");
  fprintf(fp, "  fi\n");
  fprintf(fp, "fi\n");
